...
enum{TIMER_BEEPER_OFF,TIMER_NEXT_REPORT,TIMER_RECALL,TIMER_SLEEP,TIMER_STOP_DOOR,TIMER_STOP_RING_BEL,TIMER_ROT_TOGGLE,TIMER_BLOCKING_END,TIMER_SAVE_DELAY};
